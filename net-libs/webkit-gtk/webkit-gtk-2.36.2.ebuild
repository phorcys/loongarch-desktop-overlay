...
IUSE="aqua avif +egl examples gamepad +geolocation gles2-only gnome-keyring +gstreamer gtk-doc +introspection +jpeg2k +jumbo-build lcms libnotify spell systemd test wayland X"
...
src_prepare() {
	eapply "${FILESDIR}"/2.36.loongarch-support.patch
	eapply "${FILESDIR}"/2.36.loongarch-loongarch-fix-openjpeg.patch
